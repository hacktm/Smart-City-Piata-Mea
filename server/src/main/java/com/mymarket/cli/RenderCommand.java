...
public class RenderCommand extends ConfiguredCommand<MyMarketConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<MyMarketConfiguration> bootstrap,
                       Namespace namespace,
                       MyMarketConfiguration configuration) throws Exception {
